import json
from utilities.sub_market_callback import P_HUOBI
from app.strategies.turtle.trader import Trader
from datetime import datetime
from app.data.huobi import HuoBiData
import pandas as pd
import talib
...
class MinutesTrendReversalStrategy(BaseStrategy):
...
if __name__ == '__main__':
    turtle = MinutesTrendReversalStrategy('BTC_CQ')
